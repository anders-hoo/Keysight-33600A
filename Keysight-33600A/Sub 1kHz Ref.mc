...
=============================================================================
 STEP    FSC    RANGE NOMINAL        TOLERANCE     MOD1        MOD2  3  4 CON
  ...
  1.004  LABEL        5790
  1.005  SCPI         OUTP:LOAD 50
  1.006  SCPI         VOLT:UNIT VRMS
  1.007  SCPI         [@5790][T60000]RANGE [V @v_ampl];HIRES 0 ; DFILT OFF ; INPUT WBND; EXTRIG 0; REFCLR
  1.008  SCPI         APPLy:SIN 1e3,[V @v_ampl],0
  ...
  1.014  LABEL        FSMR
  1.015  SCPI         OUTP:LOAD 50
  1.016  SCPI         VOLT:UNIT VRMS
  1.016  SCPI         [@FSMR]INIT:CONT ON
  1.017  SCPI         APPLy:SIN 1e3,[V @v_ampl],0[D5000]
